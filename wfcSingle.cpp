...
vector<BuildingBlock> BUILDINGBLOCKS{
    ...
    // 4 new dead-ends
    BuildingBlock("DeadendLeft", vector<uint8_t>{0, 0, 0, 1, 1, 0, 0, 0, 0},
                  new bool[4]{false, false, true, false}, 3, 2.0),
    BuildingBlock("DeadendRight", vector<uint8_t>{0, 0, 0, 0, 1, 1, 0, 0, 0},
                  new bool[4]{false, false, false, true}, 3, 2.0),
    BuildingBlock("DeadendTop", vector<uint8_t>{0, 1, 0, 0, 1, 0, 0, 0, 0},
                  new bool[4]{true, false, false, false}, 3, 2.0),
    BuildingBlock("DeadendBottom", vector<uint8_t>{0, 0, 0, 0, 1, 0, 0, 1, 0},
                  new bool[4]{false, true, false, false}, 3, 2.0),
};
...
int main(int argc, char* argv[]) {
  ...
  cout << "Generating a " << ndim << "X" << ndim
       << " maze using num_threads: " << num_threads << endl;
  ...
  cout << "is it valid: " << wfc.validate() << endl << endl;
